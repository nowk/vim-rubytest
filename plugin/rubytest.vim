...
function s:GetSenarioOutlineLine(str)
...
let s:test_case_patterns['feature'] = {'^\s*Scenario:':function('s:GetStoryLine'), '^\s*Scenario Outline:':function('s:GetSenarioOutlineLine')}
